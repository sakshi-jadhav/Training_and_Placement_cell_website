	...
	<div class="container-fluid">
		<div id="mySidebar" class="sidebar">
			...
			<a href="CompanyAdd.jsp">Add Company</a> <a href="#">Add Training</a> <a
				href="DisplayStudReg">Student Record</a> <a
				...
				<div class="collapse navbar-collapse justify-content-end"
					...
					<ul class="navbar-nav">
						<a href="#AboutUs" class="nav-item nav-link" style="color: white;">About
							us</a>
						<a href="Dashboard.jsp" class="nav-item nav-link" style="color: white;">Logout</a>
						<a href="StudProfile.jsp" class="nav-item nav-link" style="color: white;"><i
